...
import net.mcreator.reignmod.network.HunterWindowButtonMessage;
...
public class HunterWindowScreen extends AbstractContainerScreen<HunterWindowMenu> implements WidgetScreen {
	private final static HashMap<String, Object> guistate = HunterWindowMenu.guistate;
	...
	public HunterWindowScreen(HunterWindowMenu container, Inventory inventory, Component text) {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 62 && mouseX < leftPos + 70 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.hunter_window.tooltip_lvl1_description"), mouseX, mouseY);
		if (mouseX > leftPos + 86 && mouseX < leftPos + 94 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.hunter_window.tooltip_lvl2_description"), mouseX, mouseY);
		if (mouseX > leftPos + 110 && mouseX < leftPos + 118 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.hunter_window.tooltip_lvl3_description_l"), mouseX, mouseY);
		if (mouseX > leftPos + 134 && mouseX < leftPos + 142 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.hunter_window.tooltip_lvl4_description"), mouseX, mouseY);
		if (mouseX > leftPos + 158 && mouseX < leftPos + 166 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.hunter_window.tooltip_lvl5_description"), mouseX, mouseY);
	}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("reign_mod:textures/screens/big_hunter_logo.png"), this.leftPos + 9, this.topPos + 9, 0, 0, 48, 48, 48, 48);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_string_1"), 15, 69, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_string_2"), 15, 87, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_string_3"), 15, 98, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_string_4"), 15, 109, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_string_5"), 15, 120, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_string_6"), 15, 138, -10066330, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_main_label"), 63, 9, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.hunter_window.label_add_license"), 1, -12, -1, false);
	}

	@Override
	public void init() {
		super.init();
		button_select = Button.builder(Component.translatable("gui.reign_mod.hunter_window.button_select"), e -> {
			if (IsNotHaveAddLicensesProcedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(0, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		...
		button_empty = Button.builder(Component.translatable("gui.reign_mod.hunter_window.button_empty"), e -> {
			if (true) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(1, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		}).bounds(this.leftPos + -21, this.topPos + 1, 19, 20).build();
		guistate.put("button:button_empty", button_empty);
		this.addRenderableWidget(button_empty);
		button_refuse = Button.builder(Component.translatable("gui.reign_mod.hunter_window.button_refuse"), e -> {
			if (IsHaveAddLicensesProcedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(2, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		...
		imagebutton_upgrade_lvl = new ImageButton(this.leftPos + 58, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl.png"), 16, 32, e -> {
			if (AddLvlUp1Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(3, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 3, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl1 = new ImageButton(this.leftPos + 82, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl1.png"), 16, 32, e -> {
			if (AddLvlUp2Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(4, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 4, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl2 = new ImageButton(this.leftPos + 106, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl2.png"), 16, 32, e -> {
			if (AddLvlUp3Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(5, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 5, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl3 = new ImageButton(this.leftPos + 130, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl3.png"), 16, 32, e -> {
			if (AddLvlUp4Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(6, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 6, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl5 = new ImageButton(this.leftPos + 154, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl5.png"), 16, 32, e -> {
			if (AddLvlUp5Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new HunterWindowButtonMessage(7, x, y, z, textstate));
				HunterWindowButtonMessage.handleButtonAction(entity, 7, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
