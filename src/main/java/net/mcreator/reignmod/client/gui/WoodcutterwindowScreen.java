...
public class WoodcutterwindowScreen extends AbstractContainerScreen<WoodcutterwindowMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 62 && mouseX < leftPos + 70 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.woodcutterwindow.tooltip_lvl1_description"), mouseX, mouseY);
		if (mouseX > leftPos + 86 && mouseX < leftPos + 94 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.woodcutterwindow.tooltip_lvl2_description"), mouseX, mouseY);
		if (mouseX > leftPos + 110 && mouseX < leftPos + 118 && mouseY > topPos + 29 && mouseY < topPos + 37)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.woodcutterwindow.tooltip_lvl3_description_l"), mouseX, mouseY);
		if (mouseX > leftPos + 110 && mouseX < leftPos + 118 && mouseY > topPos + 43 && mouseY < topPos + 51)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.woodcutterwindow.tooltip_lvl3_description_r"), mouseX, mouseY);
		if (mouseX > leftPos + 134 && mouseX < leftPos + 142 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.woodcutterwindow.tooltip_lvl4_description"), mouseX, mouseY);
		if (mouseX > leftPos + 158 && mouseX < leftPos + 166 && mouseY > topPos + 36 && mouseY < topPos + 44)
			guiGraphics.renderTooltip(font, Component.translatable("gui.reign_mod.woodcutterwindow.tooltip_lvl5_description"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_l"), 117, 20, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_r"), 117, 51, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_string_1"), 15, 69, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_string_2"), 15, 87, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_string_3"), 15, 98, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_string_4"), 15, 109, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_string_5"), 15, 120, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_string_6"), 15, 138, -10066330, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.reign_mod.woodcutterwindow.label_main_label"), 63, 9, -1, false);
	}
	...
	public void init() {
		...
		imagebutton_upgrade_lvl = new ImageButton(this.leftPos + 58, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl.png"), 16, 32, e -> {
			if (MainLvlUp1Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new WoodcutterwindowButtonMessage(3, x, y, z, textstate));
				WoodcutterwindowButtonMessage.handleButtonAction(entity, 3, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl1 = new ImageButton(this.leftPos + 82, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl1.png"), 16, 32, e -> {
			if (MainLvlUp2Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new WoodcutterwindowButtonMessage(4, x, y, z, textstate));
				WoodcutterwindowButtonMessage.handleButtonAction(entity, 4, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl2 = new ImageButton(this.leftPos + 106, this.topPos + 25, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl2.png"), 16, 32, e -> {
			if (MainLvlUp3Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new WoodcutterwindowButtonMessage(5, x, y, z, textstate));
				WoodcutterwindowButtonMessage.handleButtonAction(entity, 5, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl3 = new ImageButton(this.leftPos + 106, this.topPos + 39, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl3.png"), 16, 32, e -> {
			if (MainLvlUp3Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new WoodcutterwindowButtonMessage(6, x, y, z, textstate));
				WoodcutterwindowButtonMessage.handleButtonAction(entity, 6, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl4 = new ImageButton(this.leftPos + 130, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl4.png"), 16, 32, e -> {
			if (MainLvlUp4Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new WoodcutterwindowButtonMessage(7, x, y, z, textstate));
				WoodcutterwindowButtonMessage.handleButtonAction(entity, 7, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_upgrade_lvl5 = new ImageButton(this.leftPos + 154, this.topPos + 32, 16, 16, 0, 0, 16, new ResourceLocation("reign_mod:textures/screens/atlas/imagebutton_upgrade_lvl5.png"), 16, 32, e -> {
			if (MainLvlUp5Procedure.execute(entity)) {
				ReignModMod.PACKET_HANDLER.sendToServer(new WoodcutterwindowButtonMessage(8, x, y, z, textstate));
				WoodcutterwindowButtonMessage.handleButtonAction(entity, 8, x, y, z, textstate);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
