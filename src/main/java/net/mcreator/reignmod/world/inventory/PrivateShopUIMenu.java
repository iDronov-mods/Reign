...
public class PrivateShopUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PrivateShopUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 44, 26) {
			...
			public boolean mayPickup(Player entity) {
				return !PrivateShopClearPriceProcedure.execute(entity);
			}
			...
			public boolean mayPlace(ItemStack itemstack) {
				return !PrivateShopSetPriceProcedure.execute(world, x, y, z, entity, itemstack);
			}
		}));
