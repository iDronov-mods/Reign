...
public class PrivateShopBuyerUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PrivateShopBuyerUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ReignModModMenus.PRIVATE_SHOP_BUYER_UI.get(), id);
