...
public class HoarderMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HoarderMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ReignModModMenus.HOARDER.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 59, 33) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 99, 33) {
