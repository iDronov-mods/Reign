...
public class CoffersUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CoffersUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ReignModModMenus.COFFERS_UI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 26, 36) {
