...
public class ReignModModVariables {
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			clone.Your_Majesty = original.Your_Majesty;
			...
			clone.LordisNumberKingdom = original.LordisNumberKingdom;
			clone.PlayerColor = original.PlayerColor;
	...
	public static class MapVariables extends SavedData {
		...
		public void read(CompoundTag nbt) {
			...
			white_free = nbt.getBoolean("white_free");
			yellow_free = nbt.getBoolean("yellow_free");
			lime_free = nbt.getBoolean("lime_free");
			green_free = nbt.getBoolean("green_free");
			biruz_free = nbt.getBoolean("biruz_free");
			blue_free = nbt.getBoolean("blue_free");
			purple_free = nbt.getBoolean("purple_free");
			pink_free = nbt.getBoolean("pink_free");
			red_free = nbt.getBoolean("red_free");
			orange_free = nbt.getBoolean("orange_free");
			brown_free = nbt.getBoolean("brown_free");
			black_free = nbt.getBoolean("black_free");
		...
		public CompoundTag save(CompoundTag nbt) {
			...
			nbt.putBoolean("white_free", white_free);
			nbt.putBoolean("yellow_free", yellow_free);
			nbt.putBoolean("lime_free", lime_free);
			nbt.putBoolean("green_free", green_free);
			nbt.putBoolean("biruz_free", biruz_free);
			nbt.putBoolean("blue_free", blue_free);
			nbt.putBoolean("purple_free", purple_free);
			nbt.putBoolean("pink_free", pink_free);
			nbt.putBoolean("red_free", red_free);
			nbt.putBoolean("orange_free", orange_free);
			nbt.putBoolean("brown_free", brown_free);
			nbt.putBoolean("black_free", black_free);
	...
	public static class PlayerVariables {
		...
		public double LordisNumberKingdom = 0;
		...
		public Tag writeNBT() {
			...
			nbt.putBoolean("Your_Majesty", Your_Majesty);
			...
			nbt.putDouble("LordisNumberKingdom", LordisNumberKingdom);
			nbt.putString("PlayerColor", PlayerColor);
		...
		public void readNBT(Tag tag) {
			...
			Your_Majesty = nbt.getBoolean("Your_Majesty");
			...
			LordisNumberKingdom = nbt.getDouble("LordisNumberKingdom");
			PlayerColor = nbt.getString("PlayerColor");
		...
		public static void handler(PlayerVariablesSyncMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
			...
			context.enqueueWork(() -> {
				if (!context.getDirection().getReceptionSide().isServer()) {
					...
					variables.Your_Majesty = message.data.Your_Majesty;
					...
					variables.isLord = message.data.isLord;
					...
					variables.LordisNumberKingdom = message.data.LordisNumberKingdom;
					variables.PlayerColor = message.data.PlayerColor;
