...
public class AddLicenseListButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public AddLicenseListButtonMessage(FriendlyByteBuf buffer) {
	...
	public AddLicenseListButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(AddLicenseListButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(AddLicenseListButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = AddLicenseListMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ReignModMod.addNetworkMessage(AddLicenseListButtonMessage.class, AddLicenseListButtonMessage::buffer, AddLicenseListButtonMessage::new, AddLicenseListButtonMessage::handler);
	}
