	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		...
		if ((entity.getCapability(ReignModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ReignModModVariables.PlayerVariables())).license_miner) {
			...
			if ((entity.getCapability(ReignModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ReignModModVariables.PlayerVariables())).MAIN_LVL < 2) {
				if (blockstate.getBlock() == Blocks.COBBLED_DEEPSLATE || blockstate.getBlock() == Blocks.DEEPSLATE || blockstate.getBlock() == Blocks.DEEPSLATE_COAL_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_IRON_ORE
						|| blockstate.getBlock() == Blocks.DEEPSLATE_REDSTONE_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_GOLD_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_LAPIS_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_DIAMOND_ORE
						|| blockstate.getBlock() == Blocks.DEEPSLATE_EMERALD_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_COPPER_ORE) {
			...
			if ((entity.getCapability(ReignModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ReignModModVariables.PlayerVariables())).MAIN_LVL >= 3) {
				if (Mth.nextInt(RandomSource.create(), 1, 4) == 1 && !(EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0)) {
					if (blockstate.getBlock() == Blocks.COAL_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_COAL_ORE) {
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.COAL));
							entityToSpawn.setPickUpDelay(5);
							_level.addFreshEntity(entityToSpawn);
						}
					} else if ((blockstate.getBlock() == Blocks.IRON_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_IRON_ORE) && ReignModModVariables.MapVariables.get(world).ERA >= 1) {
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.RAW_IRON));
							entityToSpawn.setPickUpDelay(5);
							_level.addFreshEntity(entityToSpawn);
						}
					} else if ((blockstate.getBlock() == Blocks.REDSTONE_ORE || blockstate.getBlock() == Blocks.REDSTONE_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_REDSTONE_ORE) && ReignModModVariables.MapVariables.get(world).ERA >= 5) {
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.REDSTONE));
							entityToSpawn.setPickUpDelay(5);
							_level.addFreshEntity(entityToSpawn);
						}
					} else if (blockstate.getBlock() == Blocks.COPPER_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_COPPER_ORE) {
						if (world instanceof ServerLevel _level) {
			...
			if ((entity.getCapability(ReignModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ReignModModVariables.PlayerVariables())).MAIN_LVL >= 4 && ReignModModVariables.MapVariables.get(world).ERA >= 4) {
				if (Mth.nextInt(RandomSource.create(), 1, 4) == 1 && !(EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0)) {
					if (blockstate.getBlock() == Blocks.GOLD_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_GOLD_ORE || blockstate.getBlock() == Blocks.NETHER_GOLD_ORE) {
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.RAW_GOLD));
							entityToSpawn.setPickUpDelay(5);
							_level.addFreshEntity(entityToSpawn);
						}
					} else if (blockstate.getBlock() == Blocks.DIAMOND_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_DIAMOND_ORE) {
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.DIAMOND));
							entityToSpawn.setPickUpDelay(5);
							_level.addFreshEntity(entityToSpawn);
						}
					} else if (blockstate.getBlock() == Blocks.EMERALD_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_EMERALD_ORE) {
						if (world instanceof ServerLevel _level) {
