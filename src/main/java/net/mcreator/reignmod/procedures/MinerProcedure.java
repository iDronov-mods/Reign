					...
					if (blockstate.is(BlockTags.create(new ResourceLocation("forge:ores")))) {
						...
						if (Mth.nextInt(RandomSource.create(), 1, 100) <= (entity.getCapability(ReignModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ReignModModVariables.PlayerVariables())).efficiency) {
							if ((entity.getCapability(ReignModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ReignModModVariables.PlayerVariables())).MAIN_LVL < 3
								...
								if (blockstate.getBlock() == Blocks.DEEPSLATE_GOLD_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_LAPIS_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_DIAMOND_ORE
										|| blockstate.getBlock() == Blocks.DEEPSLATE_EMERALD_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_COPPER_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_COAL_ORE
										|| blockstate.getBlock() == Blocks.DEEPSLATE_IRON_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_REDSTONE_ORE) {
